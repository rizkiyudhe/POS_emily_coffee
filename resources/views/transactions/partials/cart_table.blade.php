            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 text-right text-sm text-gray-900">Rp {{ number_format($item['subtotal'], 0, ',', '.') }}</td>
                        <td class="px-4 py-2 text-center">
                            <button class="remove-item text-red-600 hover:text-red-800" data-id="{{ $id }}">✖</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
